<div class="panel-body">
    ...
    {if $push_blocks}
        ...
        <div id="ngpush-list" class="Grid Grid-cell u-sizeFull">
            {foreach $push_blocks as $index => $entry}
                ...
                {switch match=$account.Type}
                    ...
                    <table cellspacing="0" class="Table ngpush-block type-{$account.Type}"
                           id="ngpush-{$entry}">
                        <thead>
                        <tr class="u-background-grey-20">
                                ...
                                <div class="account-body float-break{if $active_blocks|contains($entry)} account-body-active{/if}">
                                    ...
                                    <form action="" class="form">
                                        <div class="Form-field">
                                            <label class="Form-label maxlength"><strong>{"You have %number characters remaining."|i18n("ngpush/status", "", hash("%number", "<span>140</span>"))}</strong></label>
                                            <textarea rows="1" cols="80" name="tw_status"
                                                      spellcheck="false"
                                                      class="Form-input maxlength maxlength-140">{$account.tw_status}</textarea>
                                        </div>
                                        {if $hashtags|count}
                                            <div>
                                        ...
                                        <div class="u-margin-top-s">
                                            ...
                                            <input class="ngpush-status" type="hidden"
                                                   value=""/>
                                            <input {if $post.is_pushable|not()}disabled="disabled"{/if}
                                                   type="button"
                                ...
                                <div class="account-body float-break{if $active_blocks|contains($entry)} account-body-active{/if}">
                                    ...
                                    <form action="">
                                        <div class="Form-field">
                                            ...
                                            <input class="Form-input" name="fb_name" type="text"
                                                   value="{$account.fb_name}" size="80"/><br/>
                                        </div>

                                        <div class="Form-field u-margin-bottom-s">
                                            <label><input name="fb_description" type="checkbox"
                                                          checked="checked"/><strong>Description</strong></label>
                                            <textarea rows="5" cols="80" name="fb_description" class="Form-input"
                                        ...
                                        <div class="Form-field u-margin-bottom-s">
                                            ...
                                            <textarea rows="5" cols="80" name="fb_message" class="Form-input"
                                        ...
                                        <div class="Form-field u-margin-bottom-s">
                                            ...
                                            <input class="Form-input form-control" name="fb_link" type="text"
            ...
            <div class="u-padding-left-xl u-padding-bottom-m">
                <input {if $post.is_pushable|not()}disabled="disabled"{/if} type="button"
    ...
    {else}
        <div class="Grid Grid-cell u-sizeFull">
