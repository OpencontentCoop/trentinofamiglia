$(document).ready(function () {
    ...
    $('#CreatePianoButton').on('click', function(e){
        $('#form').opendataFormCreate({
            class: $(this).data('class'),
            parent: $(this).data('parent')
        }, {
            connector: 'create-piano-comunale',
            onSuccess: function(data){
                // gestire eventuali errori
              console.log(data);
              if (data) {
                window.location.href = $.opendataTools.settings('accessPath') + '/editorialstuff/edit/piano_comunale/' + data;
              }
